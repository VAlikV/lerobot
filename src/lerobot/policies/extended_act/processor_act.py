...
from lerobot.policies.extended_act.configuration_act import ACTConfig
...
# The dynamic policy factory derives this function name from the registered
# policy type ("extended_act").
make_extended_act_pre_post_processors = make_act_pre_post_processors
